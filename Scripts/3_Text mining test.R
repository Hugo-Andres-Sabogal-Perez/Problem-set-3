...
<<<<<<< Updated upstream:Scripts/3_Text mining test.R
...
texto <- read.table("text_mining_test.csv", header = T, sep = ",")
...
write.csv(x = AREA, file = "text_mining_area_test.csv", row.names = FALSE)


>>>>>>> Stashed changes:Scripts/Text mining test.R
